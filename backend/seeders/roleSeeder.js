...
const canonicalRoles = [
  ...
  // Peran spesifik bidang / UPTD (selaras getDashboardPath & authController.roleToDashboard)
  {
    id: uuidv4(),
    code: "pelaksana_ketersediaan",
    name: "Pelaksana Ketersediaan",
    level: 180,
    description: "Pelaksana teknis lapangan bidang ketersediaan dan kerawanan pangan.",
    default_permissions: ["create:stok_records", "read:stok_records", "update:stok_records"],
    is_active: true,
  },
  {
    id: uuidv4(),
    code: "pelaksana_distribusi",
    name: "Pelaksana Distribusi",
    level: 181,
    description: "Pelaksana teknis lapangan bidang distribusi pangan.",
    default_permissions: ["create:stok_records", "read:stok_records", "update:stok_records"],
    is_active: true,
  },
  {
    id: uuidv4(),
    code: "pelaksana_konsumsi",
    name: "Pelaksana Konsumsi",
    level: 52,
    description: "Pelaksana teknis lapangan bidang konsumsi dan keamanan pangan.",
    default_permissions: ["create:stok_records", "read:stok_records", "update:stok_records"],
    is_active: true,
  },
  {
    id: uuidv4(),
    code: "fungsional_ketersediaan",
    name: "Fungsional Ketersediaan",
    level: 183,
    description: "Jabatan fungsional verifikasi/analisis bidang ketersediaan.",
    default_permissions: ["analyze:data", "verify:requests", "read:field_data"],
    is_active: true,
  },
  {
    id: uuidv4(),
    code: "fungsional_distribusi",
    name: "Fungsional Distribusi",
    level: 184,
    description: "Jabatan fungsional verifikasi/analisis bidang distribusi.",
    default_permissions: ["analyze:data", "verify:requests", "read:field_data"],
    is_active: true,
  },
  {
    id: uuidv4(),
    code: "fungsional_konsumsi",
    name: "Fungsional Konsumsi",
    level: 185,
    description: "Jabatan fungsional verifikasi/analisis bidang konsumsi.",
    default_permissions: ["analyze:data", "verify:requests", "read:field_data"],
    is_active: true,
  },
];
