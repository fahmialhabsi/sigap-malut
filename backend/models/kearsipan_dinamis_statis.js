export default (sequelize, DataTypes) => {
  const kearsipan_dinamis_statis = sequelize.define(
    "kearsipan_dinamis_statis",
    {
      id: {
        type: DataTypes.UUID,
        primaryKey: true,
    ...
    { tableName: "kearsipan_dinamis_statis", timestamps: true },
  );
  

kearsipan_dinamis_statis.associate = (models) => {
  kearsipan_dinamis_statis.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
};
return kearsipan_dinamis_statis;
};
