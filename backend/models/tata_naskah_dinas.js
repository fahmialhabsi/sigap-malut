export default (sequelize, DataTypes) => {
  const tata_naskah_dinas = sequelize.define(
    "tata_naskah_dinas",
    {
      id: {
        type: DataTypes.UUID,
    ...
    { tableName: "tata_naskah_dinas", timestamps: true },
  );
  

tata_naskah_dinas.associate = (models) => {
  tata_naskah_dinas.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
};
return tata_naskah_dinas;
};
