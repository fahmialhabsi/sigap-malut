export default (sequelize, DataTypes) => {
  const agenda_disposisi_pimpinan = sequelize.define(
    "agenda_disposisi_pimpinan",
    {
      id: {
        type: DataTypes.UUID,
        primaryKey: true,
    ...
    { tableName: "agenda_disposisi_pimpinan", timestamps: true },
  );
  

agenda_disposisi_pimpinan.associate = (models) => {
  agenda_disposisi_pimpinan.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
};
return agenda_disposisi_pimpinan;
};
