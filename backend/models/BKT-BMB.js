...
const BktBmb = sequelize.define('BktBmb', {
  id: {
  ...
  layanan_id: {
    ...
    allowNull: false,
    comment: 'FK ke layanan_menpanrb (LY067-LY071)',
  },
  jenis_bimbingan: {
    type: DataTypes.ENUM('Bimtek', 'Supervisi', 'Pemetaan', 'Pendampingan', 'Konsultasi'),
    allowNull: false,
  ...
  nama_kegiatan: {
    ...
    allowNull: false,
    comment: 'Nama kegiatan bimtek/supervisi',
  },
  tanggal_kegiatan: {
  ...
  sasaran_peserta: {
    type: DataTypes.STRING(255),
    comment: 'Petani/aparatur/UMKM/dll',
  },
  jumlah_peserta: {
    type: DataTypes.INTEGER,
  ...
  metode_pelaksanaan: {
    ...
    comment: 'Metode pelaksanaan',
  },
  topik_pemetaan: {
    type: DataTypes.STRING(255),
    comment: 'Untuk bimtek pemetaan',
  },
  hasil_pemetaan: {
    type: DataTypes.TEXT,
    comment: 'Hasil pemetaan kerawanan',
  },
  area_supervisi: {
    type: DataTypes.STRING(255),
    comment: 'Area yang disupervisi',
  },
  temuan_supervisi: {
    type: DataTypes.TEXT,
  ...
  jawaban_konsultasi: {
    type: DataTypes.TEXT,
    comment: 'Jawaban/solusi',
  },
  durasi_pendampingan: {
    type: DataTypes.STRING(100),
    comment: 'Lama pendampingan',
  },
  ...
  file_materi: {
    type: DataTypes.JSON,
    comment: 'Array file materi PPT/PDF',
  },
  file_daftar_hadir: {
    type: DataTypes.STRING(255),
    comment: 'Daftar hadir peserta',
  },
  file_dokumentasi: {
    type: DataTypes.JSON,
  ...
  is_sensitive: {
    ...
    allowNull: false,
    defaultValue: 'Biasa',
    comment: 'Konsultasi teknis sensitif',
  },
  status: {
