export default (sequelize, DataTypes) => {
  const administrasi_umum = sequelize.define(
    'administrasi_umum',
    {
    ...
    { tableName: 'administrasi_umum', timestamps: true },
  );
  

administrasi_umum.associate = (models) => {
  administrasi_umum.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
};
return administrasi_umum;
};
