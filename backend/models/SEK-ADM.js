...
// TABLE: sek_adm
// MODULE: SEK-ADM
// Generated: 2026-03-19T23:39:22.799Z
// =====================================================

import { DataTypes } from 'sequelize';
import sequelize from '../config/database.js';

const SekAdm = sequelize.define('SekAdm', {
  id: {
  ...
  jenis_naskah: {
    type: DataTypes.ENUM('"Surat Masuk', 'Surat Keluar', 'SK', 'SE', 'ST', 'SU', 'ND', 'MEMO', 'BA', 'Nota Dinas', 'Lainnya"'),
