...
const HasilUjiKimia = sequelize.define("HasilUjiKimia", {
  ...
  batas_max_snk: { type: DataTypes.DECIMAL(12, 4), allowNull: true },
  ...
  tableName: "hasil_uji_kimia",
  timestamps: false,
});

export default HasilUjiKimia;
