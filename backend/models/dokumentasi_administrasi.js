export default (sequelize, DataTypes) => {
  const dokumentasi_administrasi = sequelize.define(
    "dokumentasi_administrasi",
    {
      id: {
        type: DataTypes.UUID,
        primaryKey: true,
    ...
    { tableName: "dokumentasi_administrasi", timestamps: true },
  );
  

dokumentasi_administrasi.associate = (models) => {
  dokumentasi_administrasi.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
};
return dokumentasi_administrasi;
};
