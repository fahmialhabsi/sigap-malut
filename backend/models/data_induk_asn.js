export default (sequelize, DataTypes) => {
  const data_induk_asn = sequelize.define(
    "data_induk_asn",
    {
      id: {
        type: DataTypes.UUID,
    ...
    { tableName: "data_induk_asn", timestamps: true },
  );
  

data_induk_asn.associate = (models) => {
  data_induk_asn.belongsTo(models.Layanan, { foreignKey: "layanan_id", as: "layanan" });
  data_induk_asn.belongsTo(models.Asn, { foreignKey: "asn_id", as: "asn" });
};
return data_induk_asn;
};
