...
// Alias: POST /surat/masuk/:id/disposisi — id diambil dari URL, selebihnya dari body
router.post("/masuk/:id/disposisi", protect, (req, res, next) => {
  req.body.surat_masuk_id = req.body.surat_masuk_id || req.params.id;
  return buatDisposisi(req, res, next);
});
router.put(
...
// Alias: PUT /surat/keluar/:id/ttd — tanda tangan sekretaris
router.put("/keluar/:id/ttd", protect, approveSuratKeluar);
