...
export default defineConfig({
  ...
  define: {
    ...
    "process.env": {},
    // Pastikan VITE_API_URL tersedia via process.env sehingga kode yang di-mock oleh Jest tidak perlu import.meta
    "process.env.VITE_API_URL": "import.meta.env.VITE_API_URL",
    "process.env.VITE_BACKEND_URL": "import.meta.env.VITE_BACKEND_URL",
    "process.env.VITE_EPELARA_URL": "import.meta.env.VITE_EPELARA_URL",
  },
  build: {
