...
export default function DashboardKasiUPTD() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => setStaff(Array.isArray(res.data?.data) ? res.data.data : []))
      .catch(() => setStaff([]))
  ...
  const SIDEBAR_MENU = [
    ...
    { id: "workspace", label: isMutu ? "Sertifikasi & Audit" : "Uji Lab & Sampling", icon: isMutu ? "🏆" : "🔬" },
      ...
      case "overview":
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <PanelBox title="👥 Tim Saya (Pelaksana Seksi)">
                {staffLoading ? (
                  ...
                  <p className="text-sm text-gray-400 italic">Pelaksana belum terdaftar.</p>
                ) : (
                  <div className="space-y-2">
            ...
            <div>{isMutu ? <WorkspaceSertifikasiMutu /> : <WorkspaceUjiLabTeknis />}</div>
          </div>
        );
      case "workspace":
        return isMutu ? <WorkspaceSertifikasiMutu /> : <WorkspaceUjiLabTeknis />;
      case "tim":
        return (
        ...
        return (
          <PanelBox title="📋 Assign Tugas ke Pelaksana (dibatasi seksi)">
            <p className="text-xs text-gray-500 mb-3">
              Dual-track enforcement aktif: Kasi Mutu hanya ke Pelaksana Mutu, Kasi Teknis hanya ke Pelaksana Teknis.
            </p>
            <form onSubmit={handleAssign} className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="text-xs text-gray-600 block mb-1">Pelaksana</label>
                  <select
