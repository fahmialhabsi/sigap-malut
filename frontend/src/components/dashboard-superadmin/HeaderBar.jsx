...
export default function HeaderBar() {
  return (
    <header className="fixed left-20 top-0 w-[calc(100vw-5rem)] h-16 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/85 flex items-center px-6 z-10">
      {/* Logo */}
      <div className="w-11 h-11 rounded-lg bg-white flex items-center justify-center mr-4">
        <span className="text-xs text-gray-400">LOGO</span>
      </div>
      {/* Title */}
      <span className="text-white font-bold text-xl mr-6">
        SIGAP Malut · Dinas Pangan
      </span>
      {/* Mission Control badge */}
      <div className="bg-yellow-400 rounded-full px-6 py-1 h-7 flex items-center mr-6">
        <span className="text-[#233441] font-bold text-base">
          Mission Control
        </span>
      </div>
      {/* Health Indicator */}
