...
export default function ListPage() {
  ...
  return (
    <PageLayout>
      <h1>SEK-LUP</h1>
      <button onClick={() => navigate("/" + "sek-lup" + "/new")}>Tambah</button>
      <Table
        columns={columns}
        data={data}
        onView={row => navigate("/" + "sek-lup" + "/" + row.id)}
        onEdit={row => navigate("/" + "sek-lup" + "/edit/" + row.id)}
