                  ...
                  <td style={{ padding: "10px 12px" }}>
                    <span
                      style={{
                        fontSize: 11,
                        fontWeight: 700,
                        background: r.tim === "Tim A" ? "#EDE7F6" : "#E0F2F1",
                        color: r.tim === "Tim A" ? "#4527A0" : "#00695C",
                        padding: "2px 9px",
                        borderRadius: 10,
                      }}
                    >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: T.textSec, marginTop: 3 }}>
                  ...
                  <strong
                    style={{ color: c.sisa_hari <= 3 ? T.danger : T.textPri }}
                  >
                    {c.batas_perbaikan}
                  </strong>
                </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      >
        ...
        <Card>
          ...
          />
          <ResponsiveContainer width="100%" height={240}>
            <RadarChart cx="50%" cy="50%" outerRadius={80} data={RADAR_WILAYAH}>
...
export default function FungsionalUPTDTeknisDashboard() {
  ...
  const userName = user?.nama || user?.name || user?.username || "Rizal M.";
  const userJabatan =
    user?.jabatan ||
    user?.position ||
  ...
  const handleAction = (id) => {
    const msg = {
      ...
      verifikasi_perbaikan:
        "Membuka antarmuka verifikasi tindak lanjut perbaikan…",
  ...
  return (
    ...
    >
            ...
            {TABS.map((t) => (
              <button
                ...
                style={{
                  ...
                  color: tab === t.id ? T.indigo : "rgba(255,255,255,0.78)",
                  border: "none",
                  cursor: "pointer",
                  padding: "8px 16px",
      ...
      >
        SIGAP-MALUT © 2026 · Dinas Pangan Provinsi Maluku Utara · UPTD Teknis —
        Inspeksi & Pengawasan · v1.0.0
      </div>
    </div>
  );
}
