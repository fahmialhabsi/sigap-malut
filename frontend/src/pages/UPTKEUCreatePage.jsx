...
export default function UPTKEUCreatePage() {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mt-6 flex gap-4">
          ...
          <button
            type="button"
            onClick={() => navigate("/module/upt-keu")}
