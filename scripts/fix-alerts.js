...
const files = [
  "SEKADMCreatePage.jsx",
  "SEKASTCreatePage.jsx",
  "SEKHUMCreatePage.jsx",
  "SEKKBJCreatePage.jsx",
  "SEKKEUCreatePage.jsx",
  "SEKLDSCreatePage.jsx",
  "SEKLKSCreatePage.jsx",
  "SEKLKTCreatePage.jsx",
  "SEKRENCreatePage.jsx",
  "SEKRMHCreatePage.jsx",
  "SekretariatTasksPage.jsx",
  "BDSCPDCreatePage.jsx",
  "BDSHRGCreatePage.jsx",
  "BDSMONCreatePage.jsx",
  "BKTKBJCreatePage.jsx",
  "BKTKRWCreatePage.jsx",
  "BKTMEVCreatePage.jsx",
  "BKTPGDCreatePage.jsx",
  "ModulePage.jsx",
];
...
for (const fname of files) {
  ...
  if (
    !content.includes('from "../utils/notify"') &&
    !content.includes("from '../utils/notify'")
  ) {
